...
//Map objects
const mymap = new Map();
const keystring = "prachi";
const keyobj = {};
const keyfunc = function () {};

mymap.set(keystring, "value associated with 'prachi'");
...
const obj = new c1("Prachi", "Female");
